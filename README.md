...
1. 🔍 **Discover** — Ask the right questions before touching data
2. 🧹 **Clean** — Pandas + SQL to turn chaos into structure
3. 📈 **Analyze** — Statistical tests, trend analysis, cohort breakdowns
4. 📊 **Visualize** — Dashboards that executives actually understand
5. 🤖 **Automate** — Python scripts that run while you sleep

**My edge:** I don't just deliver reports. I deliver insights that change decisions.
...
*   🌐 **Portfolio:** https://rafacasella.github.io/
